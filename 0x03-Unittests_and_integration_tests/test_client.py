...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
    Implementation of testclass that tests the GithubOrgClient.public_repos
    """
    @classmethod
    def setUpClass(cls) -> None:
        ...
        def fetch_payload(url):
            if url in payload_routing:
                return Mock(**{'json.return_value': payload_routing[url]})
            return HTTPError
    ...
    def test_public_repos(self) -> None:
        ...
        if it returns expected results based on fixtures
        """
        self.assertEqual(
            GithubOrgClient("google").public_repos(),
            self.expected_repos,
    ...
    def tearDownClass(cls) -> None:
        """tearDown method part od TestClass"""
